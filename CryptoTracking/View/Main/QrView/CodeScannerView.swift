...
public struct CodeScannerView: UIViewControllerRepresentable {
    ...
    public func makeUIViewController(context: Context) -> ScannerMainViewController {
        return ScannerMainViewController(showViewfinder: showViewfinder, parentView: self)
    }

    public func updateUIViewController(_ uiViewController: ScannerMainViewController, context: Context) {
